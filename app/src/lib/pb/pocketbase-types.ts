...
export type MaterialsResponse<Texpand = unknown> = Required<MaterialsRecord> &
	BaseSystemFields<Texpand>;
...
export type StripeEventsResponse<Texpand = unknown> = Required<StripeEventsRecord> &
	BaseSystemFields<Texpand>;
export type SubscriptionsResponse<Texpand = unknown> = Required<SubscriptionsRecord> &
	BaseSystemFields<Texpand>;
