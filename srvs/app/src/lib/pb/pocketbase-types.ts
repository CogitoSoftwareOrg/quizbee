...
export type BlogResponse<Ttags = unknown, Texpand = unknown> = Required<BlogRecord<Ttags>> &
	BaseSystemFields<Texpand>;
export type BlogI18nResponse<Tdata = unknown, Texpand = unknown> = Required<BlogI18nRecord<Tdata>> &
	BaseSystemFields<Texpand>;
export type FeedbacksResponse<Tmetadata = unknown, Texpand = unknown> = Required<
	FeedbacksRecord<Tmetadata>
> &
	BaseSystemFields<Texpand>;
export type LandingsResponse<Tmeta = unknown, Tstructure = unknown, Texpand = unknown> = Required<
	LandingsRecord<Tmeta, Tstructure>
> &
	BaseSystemFields<Texpand>;
