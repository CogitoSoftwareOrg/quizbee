...
export type BlogResponse<Ttags = unknown, Texpand = unknown> = Required<
  BlogRecord<Ttags>
> &
  BaseSystemFields<Texpand>;
export type BlogI18nResponse<Tdata = unknown, Texpand = unknown> = Required<
  BlogI18nRecord<Tdata>
> &
  BaseSystemFields<Texpand>;
