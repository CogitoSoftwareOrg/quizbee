...
test-prod-build:
	docker compose -f infra/compose.prod.test.yml --env-file envs/.env build

test-prod-up:
	docker compose -f infra/compose.prod.test.yml --env-file envs/.env up -d

test-prod-build-infra:
	docker compose -f infra/compose.prod.test.yml --env-file envs/.env build pb meili dragonfly
