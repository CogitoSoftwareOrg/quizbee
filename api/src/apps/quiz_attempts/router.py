...
async def _generate_feedback_task(admin_pb: AdminPB, attempt_id: str):
...
async def update_quiz_attempt_with_feedback(
    ...
    background.add_task(_generate_feedback_task, admin_pb, attempt_id)
